...
bool operator==(const ::webots_ros::field_get_type_nameResponse_<ContainerAllocator1> & lhs, const ::webots_ros::field_get_type_nameResponse_<ContainerAllocator2> & rhs)
{
