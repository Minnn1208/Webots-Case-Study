...
bool operator==(const ::webots_ros::node_get_number_of_contact_pointsResponse_<ContainerAllocator1> & lhs, const ::webots_ros::node_get_number_of_contact_pointsResponse_<ContainerAllocator2> & rhs)
{
