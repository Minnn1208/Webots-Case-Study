...
class field_import_node_from_stringRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.nodeString);
    return length + 16;
  }

  static datatype() {
    // Returns string type for a service object
    return 'webots_demo/field_import_node_from_stringRequest';
  }
...
class field_import_node_from_stringResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_demo/field_import_node_from_stringResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_demo/field_import_node_from_string'; }
};
