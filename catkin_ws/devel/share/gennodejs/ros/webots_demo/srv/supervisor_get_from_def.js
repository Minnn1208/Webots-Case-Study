...
class supervisor_get_from_defRequest {
  ...
  static datatype() {
    ...
    return 'webots_demo/supervisor_get_from_defRequest';
  }
...
class supervisor_get_from_defResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'webots_demo/supervisor_get_from_defResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_demo/supervisor_get_from_def'; }
};
