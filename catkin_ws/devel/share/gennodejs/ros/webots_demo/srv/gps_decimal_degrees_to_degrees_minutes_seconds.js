...
class gps_decimal_degrees_to_degrees_minutes_secondsRequest {
  ...
  static datatype() {
    ...
    return 'webots_demo/gps_decimal_degrees_to_degrees_minutes_secondsRequest';
  }
...
class gps_decimal_degrees_to_degrees_minutes_secondsResponse {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.degreesMinutesSeconds);
    return length + 4;
  }

  static datatype() {
    // Returns string type for a service object
    return 'webots_demo/gps_decimal_degrees_to_degrees_minutes_secondsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'webots_demo/gps_decimal_degrees_to_degrees_minutes_seconds'; }
};
