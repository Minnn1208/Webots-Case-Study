...
(cl:defmethod cl:initialize-instance :after ((m <motor_set_control_pid-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor_set_control_pid-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<motor_set_control_pid-request> is deprecated: use webots_demo-srv:motor_set_control_pid-request instead.")))

(cl:ensure-generic-function 'controlp-val :lambda-list '(m))
(cl:defmethod controlp-val ((m <motor_set_control_pid-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:controlp-val is deprecated.  Use webots_demo-srv:controlp instead.")
  (controlp m))

(cl:ensure-generic-function 'controli-val :lambda-list '(m))
(cl:defmethod controli-val ((m <motor_set_control_pid-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:controli-val is deprecated.  Use webots_demo-srv:controli instead.")
  (controli m))

(cl:ensure-generic-function 'controld-val :lambda-list '(m))
(cl:defmethod controld-val ((m <motor_set_control_pid-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:controld-val is deprecated.  Use webots_demo-srv:controld instead.")
  (controld m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<motor_set_control_pid-request>)))
  ...
  "webots_demo/motor_set_control_pidRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'motor_set_control_pid-request)))
  "Returns string type for a service object of type 'motor_set_control_pid-request"
  "webots_demo/motor_set_control_pidRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <motor_set_control_pid-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor_set_control_pid-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<motor_set_control_pid-response> is deprecated: use webots_demo-srv:motor_set_control_pid-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <motor_set_control_pid-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:success-val is deprecated.  Use webots_demo-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<motor_set_control_pid-response>)))
  ...
  "webots_demo/motor_set_control_pidResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'motor_set_control_pid-response)))
  "Returns string type for a service object of type 'motor_set_control_pid-response"
  "webots_demo/motor_set_control_pidResponse")
