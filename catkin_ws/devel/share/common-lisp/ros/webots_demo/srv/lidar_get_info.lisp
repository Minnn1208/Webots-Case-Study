...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<lidar_get_info-request> is deprecated: use webots_demo-srv:lidar_get_info-request instead.")))

(cl:ensure-generic-function 'ask-val :lambda-list '(m))
(cl:defmethod ask-val ((m <lidar_get_info-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:ask-val is deprecated.  Use webots_demo-srv:ask instead.")
  (ask m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_info-request>)))
  ...
  "webots_demo/lidar_get_infoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_info-request)))
  "Returns string type for a service object of type 'lidar_get_info-request"
  "webots_demo/lidar_get_infoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<lidar_get_info-response> is deprecated: use webots_demo-srv:lidar_get_info-response instead.")))
...
(cl:defmethod horizontalResolution-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:horizontalResolution-val is deprecated.  Use webots_demo-srv:horizontalResolution instead.")
...
(cl:defmethod numberOfLayers-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:numberOfLayers-val is deprecated.  Use webots_demo-srv:numberOfLayers instead.")
  (numberOfLayers m))

(cl:ensure-generic-function 'fov-val :lambda-list '(m))
(cl:defmethod fov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:fov-val is deprecated.  Use webots_demo-srv:fov instead.")
  (fov m))

(cl:ensure-generic-function 'verticalFov-val :lambda-list '(m))
(cl:defmethod verticalFov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:verticalFov-val is deprecated.  Use webots_demo-srv:verticalFov instead.")
  (verticalFov m))

(cl:ensure-generic-function 'minRange-val :lambda-list '(m))
(cl:defmethod minRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:minRange-val is deprecated.  Use webots_demo-srv:minRange instead.")
  (minRange m))

(cl:ensure-generic-function 'maxRange-val :lambda-list '(m))
(cl:defmethod maxRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:maxRange-val is deprecated.  Use webots_demo-srv:maxRange instead.")
  (maxRange m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<lidar_get_info-response>)))
  ...
  "webots_demo/lidar_get_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'lidar_get_info-response)))
  "Returns string type for a service object of type 'lidar_get_info-response"
  "webots_demo/lidar_get_infoResponse")
