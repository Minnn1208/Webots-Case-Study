...
(cl:defmethod cl:initialize-instance :after ((m <range_finder_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'range_finder_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<range_finder_get_info-request> is deprecated: use webots_demo-srv:range_finder_get_info-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<range_finder_get_info-request>)))
  ...
  "webots_demo/range_finder_get_infoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'range_finder_get_info-request)))
  "Returns string type for a service object of type 'range_finder_get_info-request"
  "webots_demo/range_finder_get_infoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <range_finder_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'range_finder_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name webots_demo-srv:<range_finder_get_info-response> is deprecated: use webots_demo-srv:range_finder_get_info-response instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <range_finder_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:width-val is deprecated.  Use webots_demo-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <range_finder_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader webots_demo-srv:height-val is deprecated.  Use webots_demo-srv:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<range_finder_get_info-response>)))
  ...
  "webots_demo/range_finder_get_infoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'range_finder_get_info-response)))
  "Returns string type for a service object of type 'range_finder_get_info-response"
  "webots_demo/range_finder_get_infoResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'range_finder_get_info)))
  ...
  "webots_demo/range_finder_get_info")